...
void menuCompras()
{
    ...
    int valorTotal=0;
    int valorProd[12] = {5, 11, 20, 4, 4, 7, 8, 9, 5, 6, 7, 3};
   ...
   //A função deste laço de repetição é para que os valores de confirmação sejam 0 ou 1 e não outro número qualquer fora desses valores para verificação 
    ...
    do
    {
       ...
       printf("\n");
       printf("\n---------------------------------------------------------------");
       printf("\nO valor total da compra foi de: %d Almas", valorTotal);
       printf("\n---------------------------------------------------------------");
       printf("\n");
      ...
      switch (opcaopagamento)
      {
        ...
        do
        {
           ...
           if ((cod >= 0) && (cod < cMax))
           {
              ...
              printf("\n---------------------------------------------------------------");
              printf("\nCompra realizada com sucesso, seu novo débito é de: %d Almas", clientes[cod]);
              printf("\n---------------------------------------------------------------");
